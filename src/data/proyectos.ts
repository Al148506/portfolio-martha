...
export const PROYECTOS: Proyecto[] = [
  {
    ...
    categoria: "packaging",
    imagen: imagenes["../assets/images/dummy-bolsas-melon-01.png"],
    descripcion:
  ...
  },
  {
    ...
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "packaging",
    imagen: imagenes["../assets/images/dummy-bolsas-melon-02.png"],
    descripcion:
  ...
  },
  {
    ...
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "packaging",
    imagen: imagenes["../assets/images/dummy-bolsas-melon-03.png"],
    descripcion:
...

  {
    ...
    imagen: imagenes["../assets/images/propuestas-personajes-01.png"],
    descripcion:
  ...
  },
  {
    ...
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "ilustracion",
    imagen: imagenes["../assets/images/propuestas-personajes-02.png"],
    descripcion:
  ...
  },
  {
    ...
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "ilustracion",
    imagen: imagenes["../assets/images/propuestas-personajes-03.png"],
    descripcion:
  ...
  },
  {
    ...
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "branding",
    imagen: imagenes["../assets/images/logotipo-transporte.png"],
    descripcion:
  ...
  },
  {
    ...
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "branding",
    imagen: imagenes["../assets/images/tarjetas-presentacion.jpg"], // ← .jpg
    descripcion:
  ...
  {
    id: "personajes-04",
    titulo: "Personaje Dulces Dandy",
    cliente: "Productos Alteño S.A. de C.V.",
    categoria: "ilustracion",
    imagen: imagenes["../assets/images/dulces-cacahuate.png"],
    descripcion:
      'Diseño de personaje ilustrado para la línea de dulces de leche con cacahuate "Dulces Dandy". Propuesta de estilo y personalidad para la mascota de la marca.',
    tags: ["Ilustración", "Personajes", "Alteño"],
  },
];
